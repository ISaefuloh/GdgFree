...
class ItDashboardScreen extends StatefulWidget {
  ...
  const ItDashboardScreen({super.key, required this.token});
...
class _ItDashboardScreenState extends State<ItDashboardScreen> {
  ...
  Widget build(BuildContext context) {
    final menuItems = [
      ...
      _MenuItem('Laporan Stok Generate', Icons.autorenew, () {
        Navigator.push(
          context,
          MaterialPageRoute(
              builder: (context) => LaporanStokScreen(token: widget.token)),
        );
      }),
      _MenuItem('Managemen Users', Icons.person, () {
        Navigator.push(
          context,
